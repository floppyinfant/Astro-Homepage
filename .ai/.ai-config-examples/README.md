...
- Docker
    - https://marketplace.visualstudio.com/items?itemName=formulahendry.docker-extension-pack
...
oterm
- https://ggozad.github.io/oterm/commands/
...
- https://hermes-ai.net/de/
- https://youtu.be/iyxQ6Xz1Ngw

Files
- Memory.md   // max 800 Token
- User.md     // max 500 Token
